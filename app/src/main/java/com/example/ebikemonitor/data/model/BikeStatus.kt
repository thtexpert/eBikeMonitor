...
data class BikeStatus(
    ...
    val humanCalories: Double? = null,
    val tripSpeed: Double? = null,
    val tripMaxSpeed: Double? = null,
    val tripCadence: Int? = null,
    val tripMaxCadence: Int? = null,
    val tripHumanPower: Int? = null,
    val tripMaxHumanPower: Int? = null,
    val tripPedalEnergy: Int? = null,
